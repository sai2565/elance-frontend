    ...
    return (
            <div>
                 ...
                 <div className="col-span-2 w-full space-y-2 rounded-md mt-14">
                        <div className="border border-[#c4c4c4] p-2 rounded-md space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="space-y-1">
                                <div className="px-5">
                                    <Slider value={projectDuration} onChange={handleChangeProjectDuration} style={{color:"#666666"}}/>
                                </div>
                                <div className="flex space-x-2 lg:px-5 justify-center">
                                    <img className="w-6 h-6" src="https://img.icons8.com/material/48/666666/property-time.png"/>
                                    <h1>{projectDuration}</h1>
                                    <h1 className="font-semibold">Months</h1>
