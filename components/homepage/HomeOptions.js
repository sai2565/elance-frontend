        ...
        <div>
            <div className="rounded-md border border-[#c4c4c4]">
                <div className="flex items-center cursor-pointer border-b border-[#c4c4c4]">
                    <div className="flex space-x-5 px-6 py-4 items-center transition duration-150 transform hover:scale-105">
                ...
                <div className={`flex items-center cursor-pointer border-b border-[#c4c4c4] ${status !== "clientsession" && "hidden"}`}>
                    <div className="flex space-x-5 px-6 py-4 items-center transition duration-150 transform hover:scale-105">
                ...
                <div className={`flex items-center cursor-pointer border-b border-[#c4c4c4] ${status !== "freelancersession" && "hidden"}`}>
                    <div className="flex space-x-5 px-6 py-4 items-center transition duration-150 transform hover:scale-105">
                        <img class="w-10 h-10" loading="lazy" src="https://img.icons8.com/ios-filled/100/3498DB/new-job.png"/>
